...
function cadastrarDespesa(){
    ...
    if(despesa.validarDados()){
        bd.gravar(despesa)
        document.getElementById('modal-title').innerHTML = 'Dados inseridos com sucesso'
        document.getElementById('modal-header').className = 'modal-header text-success'
        document.getElementById('modal-body').innerHTML = 'A despesa foi cadastrada com êxito!'
        ...
        document.getElementById('modal-title').innerHTML = 'Erro ao inserir os dados'
        document.getElementById('modal-header').className = 'modal-header text-danger'
        document.getElementById('modal-body').innerHTML = 'Ainda existem campos a serem preenchidos!'
